<%-- 
    Document   : afterLoginGetData
    Created on : Feb 28, 2024, 8:38:30 PM
    Author     : AMD
--%>
...
<script>
    ...
    <body>
        <div id="mySidebar" class="sidebar">
            ...
            <a  style="color: #fff">Welcome! <% 
                String UserFromLogin=(String)session.getAttribute("Username");
                out.println(UserFromLogin);
            %></a>
            
            <%--<h1><script>var name = '<?= $username?>';document.write(name)</script></h1>--%>
        ...
        <div class="navbar">
            <nav>
                <ul class="nav-items">
                    ...
                    <button class="account-button" id="sidebar" onclick="openNav()">Account</button>
        ...
        <!--<div class="slide">
                <img class="mySlides" src="venom2.jpg">
        ...
        <div class="slide-1">
            <nav>
                <ul class="items">
                    ...
                    <a href="#">
                    <img "class="mySlides" src="venom2.jpg" style="width: 200px; height: 300px;" alt="">
                    </a>
                    <a href="#">
